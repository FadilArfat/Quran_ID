      ...
      <div className="container mx-auto lg:max-w-6xl py-5 px-4 mt-12 mb-20">
        ...
        <div className="my-16 p-8 bg-emerald-900 text-white rounded-xl">
          <div>
            ...
            <p className="text-lg">
              Selamat datang di situs kami! Kami adalah komunitas yang
              berdedikasi untuk menjadikan Al-Quran lebih mudah diakses dan
              dipahami oleh semua orang. Kami percaya bahwa Al-Quran adalah
              sumber kebijaksanaan, petunjuk hidup, dan keindahan yang tak
              ternilai harganya.
            </p>
            <p className="text-lg">
              ...
              masyarakat dalam memahami dan menghargai pesan yang terkandung
              dalam setiap ayat Al-Quran, serta menjadikannya sebagai panduan
              dalam kehidupan sehari-hari.
            </p>
            <p className="text-lg">
              Situs kami menyediakan berbagai fitur yang akan membantu Anda
              dalam menjelajahi Al-Quran. Anda dapat membaca Al-Quran secara
              online dengan mudah, mencari ayat-ayat yang spesifik, mendengarkan
              bacaan yang indah dari para qari terkenal, dan menyimpan
              surah-surah yang ingin Anda simpan untuk referensi di masa depan.
            </p>
            <p className="text-lg">
        ...
        <div className="grid md:grid-cols-2 gap-16 mt-16">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Nikmati kemudahan membaca Al-Quran secara online. Jelajahi surah
              dan ayat-ayatnya dengan mudah menggunakan fitur navigasi kami.
              Dapatkan akses ke terjemahan Al-Quran dan pilihan tafsir untuk
          ...
          <motion.div
            ...
            exit={{ opacity: 0, x: 20 }}
            className="md:block hidden md:visible"
          >
            <Image
              width={200}
              height={100}
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Rasakan keindahan dan ketenangan dalam mendengarkan bacaan
              Al-Quran yang terkaji dengan baik. Kami menawarkan koleksi bacaan
              dari qari terkenal yang akan membawa hati Anda dekat dengan
              ayat-ayat-Nya.
            </p>
            <Link href={"/detail/1"}>
              <button
                ...
                className="focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-2xl text-sm px-4 py-2 text-center mt-4"
              >
                <FaHeadphones className="inline mr-2" /> Dengarkan Bacaan
                Al-Quran
              </button>
            </Link>
          </motion.div>
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Temukan ayat-ayat Al-Quran yang Anda cari dengan mudah melalui
              fitur pencarian kami. Ketikkan kata kunci, nama surah, atau nomor
              ayat yang ingin Anda temukan, dan kami akan menampilkan hasil
          ...
          <>
            ...
            >
              ...
              <p className="text-lg text-gray-600">
                ...
                dapat menyimpan surah yang ingin Anda baca atau kaji lebih
                lanjut nanti, dan mengaksesnya dengan mudah setiap saat.
                <br />
